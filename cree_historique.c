...
list_histo cree_historique(list_histo l, composition compo, char action[10], char field[50], char befor[50], char after[50]){
    list_histo new, p;
    ...
    new->info.modification_date =time(NULL);
    new->next = NULL;
